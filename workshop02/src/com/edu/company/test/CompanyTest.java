...
public class CompanyTest {
	public static void main(String[] args) {
		...
		Employee[] employees1 = { new Employee("김사원", 'M', new MyDate("2022", "7", "21"), new MyDate("1997", "5", "20"), 10000, "사장"),
		...
		Employee[] employees2 = { new Employee("김사원", 'M', new MyDate("2022", "7", "21"), new MyDate("1997", "5", "20"), 20000, "과장"),
